...
const CourseItem = ({ CourseDetails }: courseItemProp) => {
  ...
  return (
    <>
      <div className="md:w-[24%] w-[48%] p-1.5 my-auto shadow rounded">
        <div className="flex relative w-full h-24 md:h-32">
          <Image
            alt="img"
            height={100}
            width={100}
            className="absolute w-full inset-0 object-contai object-cover hover:hidden  rounded-xl"
            src={img}
          />
          <div className="absolute z-1 h-full p-4 bg-gray-900 opacity-0  hover:opacity-100 transition duration-700 rounded-xl overflow-y-scroll  text-sm md:text-md mx-auto">
            ...
            <h3 className="title-font  font-medium text-gray-50 text-xs md:text-md mb-1">
              <del>₹{price}</del> <span className="mx-1">Free</span>|
              <span className="mx-1">{likes}K+ Likes</span>|
              <span className="mx-1">{enrolledCount}K+ Enrolled</span>
            </h3>
          </div>
        </div>

        <h1 className="title-font md:text-lg text-xs font-medium myColor1 mb-3 mt-2 mx-3 line-clamp-2 text-bold">
          {name}
        </h1>
        ...
        <div className="flex mx-1">
          ...
          <button className="p-2 rounded-full bg-gray-100 mx-1">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 text-indigo-500 text-bold"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="flex mb-3 mx-2">
          <Link
            ...
            className="rounded-full bg-pink-600 text-white font-poppins mt-4 px-4 py-2 text-xs mx-auto"
          >
            Enroll Now
          </Link>
        </div>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn Top Level Skills From Top Level Teachers"
        />
      ...
      <div className="flex flex-nowrap  lg:p-8">
        <div className="w-full justify-center hidden flex-wrap pt-10 px-10 md:block ">
          <div className="mt-6 p-0">
            <span className="text-4xl text-pink-600 w-full">
            ...
            <button
              onClick={() => {
                router.push(`${URL}/courses`);
              }}
              className="rounded-full w-40 font-lato bg-pink-500 block mt-4 py-3 font-lato text-xl text-white"
            >
              Explore
            </button>
          </div>
          <div className="flex justify-left mt-0 w-full"></div>
        </div>
      ...
      <div className="py-5 p-1.5 text-center rounded-lg my-4 mx-5  text-lg ">
        ...
        <button
          onClick={() => router.push(`${URL}/courses`)}
          className="rounded-full w-28 font-lato bg-pink-500 block mt-4 py-2 text-md text-white mx-auto lg:hidden"
        >
          Explore
        </button>
      </div>
      ...
      <div className="flex flex-wrap  gap-2 mx-auto md:gap-3 md:w-[96%] w-full mt-20 md:px-3 my-16 px-2">
        <h1 className="text-3xl md:text-5xl  font-medium px-3 title-font text-gray-900 w-full mb-6 md:text-center myColor ">
          Popular Courses
        </h1>
      ...
      <div className="Main container flex flex-wrap gap-5 p-5 mx-auto ">
        <div className="Sub container flex flex-wrap justify-center pb-4 gap-3 lg:w-[45%] h-92 ">
          ...
          <div className="flex flex-wrap p-2 justify-center gap-3">
            <h2 className="text-2xl text-center myColor">
              Be a Certified Developer
            </h2>
            <p className="text-center px-2 lg:w-3/4 mx-auto ">
              Instructors from around the world teach millions of learners on
              ISkills. We provide the tools and skills to teach what you love.
            </p>
          </div>
          <button
            onClick={() => {
            ...
            className="w-72 text-xl text-white bg-cyan-500 px-5 py-2"
          >
            Start Learning
          </button>
        </div>
        ...
        <div className="Sub container flex flex-wrap justify-center py-4 gap-3 lg:w-[45%]">
          ...
          <div className="flex flex-wrap p-2 justify-center gap-3">
            ...
            <p className="text-center px-2 lg:w-3/4 mx-auto ">
              Empowering enthusiasts globally, our expert instructors inspire
              countless learners. Join us to share your passion, equipped with
              the tools and skills to ignite curiosity
            </p>
          </div>
          <button
            onClick={() => {
            ...
            className="w-72 text-xl text-white bg-purple-500 px-5 py-2"
          >
            Start Learning
          </button>
        </div>
        ...
        <div className="Sub container flex flex-wrap justify-center py-4 gap-3 lg:w-[45%]">
          ...
          <div className="flex flex-wrap p-2 justify-center gap-3">
            <h2 className="text-2xl text-center myColor">
              Learn Popular Softwares
            </h2>
            <p className="text-center px-2 lg:w-3/4 mx-auto ">
              Embark on a learning journey with our diverse community of
              instructors, guiding and inspiring learners worldwide. We equip
              you with the tools and expertise to share your knowledge and make
              a meaningful impact.
            </p>
          </div>
          <button
            ...
            className="w-72 text-xl text-white bg-red-500 px-5 py-2"
          >
            Start Learning
          </button>
        </div>
        ...
        <div className="Sub container flex flex-wrap justify-center py-4 gap-3 lg:w-[45%]">
          ...
          <div className="flex flex-wrap p-2 justify-center gap-3">
            ...
            <p className="text-center px-2 lg:w-3/4 mx-auto ">
              Dive into the world of knowledge as our international team of
              educators shapes the learning experience. Fuel your passion and
              become a beacon of inspiration – because here, teaching what you
              love is not just a skill, it&apos;s a calling.
            </p>
          </div>
          <button
            onClick={() => {
            ...
            className="w-72 text-xl text-white bg-yellow-500 px-5 py-2"
          >
            Start Learning
          </button>
        </div>
      ...
      <div className="container  p-4 mx-auto pt-12 pb-8 mt-6">
        <p className="text-center text-xl md:text-2xl lg:text-3xl md:px-6 myColor">
          Trusted By Over 15000 Companies and millions or learners around the
          world
        </p>
        <div className="logos flex justify-center p-2 gap-5 lg:gap-8 pt-6 justify-center">
          ...
          ></img>
          <img
            className="w-20 mt-2 md:w-28 lg:w-36"
        ...
        <div className="logos flex justify-center gap-4">
          <img
            ...
            src="https://www.svgrepo.com/show/303472/wordpress-logo.svg"
            alt=""
          ></img>
          <img
            className="w-16 md:w-20 lg:w-24"
          ...
          ></img>
          <img
            className="w-16 mt-2 md:w-20 lg:w-24"
            src="https://www.svgrepo.com/show/303674/call-of-duty-logo.svg"
            alt=""
          ></img>
          <img
            className="w-16 md:w-20 lg:w-24"
        ...
        <div className="logos flex justify-center gap-5 p-2 justify-center">
          ...
          ></img>
          <img
            className="w-24 mt-2 md:w-32 lg:w-36"
            src="https://www.svgrepo.com/show/303183/google-2015-logo.svg"
            alt=""
          ></img>
        </div>
      </div>
      ...
      <section className="text-gray-600  body-font">
        <div className="md:w-5/6 w-full px-5 py-12 mx-auto">
          <h1 className="md:text-5xl text-3xl font-medium title-font mb-12 text-center myColor ">
            Success Stories
          </h1>
          ...
          <div className="flex flex-unwrap -m-4 overflow-x-scroll h-60">
            <div className="p-2 md:w-1/3  w-full flex-shrink-0  ">
              <div className="h-full shadow p-8 rounded-lg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="block w-5 h-5 myColor mb-4"
                ...
                <p className="leading-relaxed text-xs text-gray-700 ">
                  Carlos&apos;s exploration of AI and machine learning reflects
                  the transformative potential of emerging technologies,
                  highlighting the impact of curiosity and experimentation..
                </p>
              </div>
            </div>
            <div className="p-2 md:w-1/3 w-full flex-shrink-0 ">
              <div className="h-full shadow p-8 rounded-lg">
                ...
                <p className="leading-relaxed text-xs text-gray-700">
                  Olivia&apos;s success as a web developer illustrates the
                  artistry and technical prowess required to create seamless
                  digital experiences, emphasizing the fusion of creativity and
                  coding.
                </p>
              </div>
            </div>
            <div className="p-2 md:w-1/3  w-full flex-shrink-0 ">
              <div className="h-full shadow p-8 rounded-lg">
                ...
                <p className="leading-relaxed text-xs text-gray-700">
                  Michael&apos;s journey into the realm of data science
                  showcases the power of harnessing data for informed
                  decision-making, emphasizing the demand for analytical skills
            ...
            <div className="p-2 md:w-1/3 w-full flex-shrink-0  ">
              <div className="h-full shadow p-8 rounded-lg">
                ...
                <p className="leading-relaxed text-gray-700 text-xs ">
                  Jason&apos;s story underscores the dynamic landscape of mobile
                  app development, emphasizing the importance of staying attuned
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  return {
    props: {
      ...
      android: JSON.parse(JSON.stringify(android)) ?? [],
      web: JSON.parse(JSON.stringify(web)) ?? [],
      machineLearning: JSON.parse(JSON.stringify(machineLearning)) ?? [],
      dataScience: JSON.parse(JSON.stringify(dataScience)) ?? [],
      devops: JSON.parse(JSON.stringify(devops)) ?? [],
    },
  };
}
