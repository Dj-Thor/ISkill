...
import { Button, Rating, IconButton, Avatar, Typography, Input, Checkbox, Textarea} from "@material-tailwind/react";
...
<Head>
 ...
 <ContainerOne/>
 <ContainerThree/>
 <Carousel Data={Data}/> {/* Require Props */}
 <ShowByCategory Data={Data} android={android} web={web} dataScience={dataScience} devops={devops} machineLearning={machineLearning}  /> {/* Required Props */}
 <ContainerSix Data={Data}/> {/* Required Props */}
 <ContainerTwo/>
 <ContainerFour/>
 <ContainerFive/>
 <Accordian/>
